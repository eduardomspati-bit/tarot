...
with open('/mnt/agents/output/server_completo.js', 'w', encoding='utf-8') as f:
    f.write(server_completo)

import subprocess
result = subprocess.run(['node', '--check', '/mnt/agents/output/server_completo.js'], 
                       capture_output=True, text=True)
print("Verificacion de sintaxis:")
print("  Return code:", result.returncode, "(0 = OK)")
print("  Errores:", result.stderr if result.stderr else "Ninguno")
print(f"  Total lineas: {len(server_completo.splitlines())}")
